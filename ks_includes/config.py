    ...
    def _create_configurable_options(self, screen):
        ...
        self.configurable_options = [
            ...
            {"theme": {
                ...
                "value": "sovol-dark", "callback": screen.restart_ks, "options": [
                    {"name": "Sovol-dark" + " " + _("(default)"), "value": "sovol-dark"}]}},
        ...
        themes = [d for d in os.listdir(t_path) if (not os.path.isfile(os.path.join(t_path, d)) and d != "sovol-dark")]
        themes.sort()
