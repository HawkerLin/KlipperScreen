...
class SystemPanel(ScreenPanel):
    def __init__(self, screen, title):
        ...
        box0 = self._gtk.Button()
        box1 = self._gtk.Button()
        box2 = self._gtk.Button()
        box3 = self._gtk.Button()
        box4 = self._gtk.Button()
        box5 = self._gtk.Button()
        box6 = self._gtk.Button()
        box7 = self._gtk.Button()
        box0.hide()
        box1.hide()
        box2.hide()
        box3.hide()
