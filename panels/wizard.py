...
class WizardPanel(ScreenPanel):
    ...
    def show_wizard_1(self):
        ...
        self.wizard_1_lbl.set_markup("<span font='DejaVu Sans-bold 30'>{}</span>".format(title))
    ...
    def show_wizard_2(self):
        ...
        self.wizard_2_lbl.set_markup("<span font='DejaVu Sans-bold 30'>{}</span>".format(title))
        ...
        self.wifi_logo.set_size_request(480, 187)
        ...
        self.wizard_2_txt_box.set_size_request(480, 373)
    ...
    def show_wizard_3(self):
        ...
        self.wizard_3_lbl.set_markup("<span font='DejaVu Sans-bold 30'>{}</span>".format(title))
