...
class WizardPanel(ScreenPanel):
    ...
    def show_wizard_2(self):
        ...
        self.second_nex.set_halign(self.Align.CENTER)
        self.second_nex.set_valign(self.Align.CENTER)
        ...
        self.second_bac.set_halign(self.Align.CENTER)
        self.second_bac.set_valign(self.Align.CENTER)
