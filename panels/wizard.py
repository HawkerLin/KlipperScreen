...
class WizardPanel(ScreenPanel):
    ...
    def show_wizard_1(self):
        ...
        self.wizard_1_title.set_size_request(480, 700)
        ...
        self.wizard_1_next.set_size_request(480, 100)
    ...
    def show_wizard_2(self):
        ...
        self.wizard_2_title.set_size_request(480, 700)
        ...
        self.wizard_2_next.set_size_request(240, 100)
